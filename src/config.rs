...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("tillty Support".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["help.tillty.com"];
pub const RS_PUB_KEY: &str = "NaApsx!4rAgUJkEYMZfwkWA.Jp4DRxbb";
